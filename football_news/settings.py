...
SECRET_KEY = 'django-insecure-#ge4%=+dmo0rs7da1z9to!5$$_70d)4(k^8mri1hyo1%+yaa6$'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "ayshia-la-footballnews.pbp.cs.ui.ac.id"]

CSRF_TRUSTED_ORIGINS = [
    "https://ayshia-la-footballnews.pbp.cs.ui.ac.id"
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # New added content
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
